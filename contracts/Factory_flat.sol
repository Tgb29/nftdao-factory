...
contract NFTDAO is ERC721{
    ...
    constructor(string memory  _name, string memory _symbol, uint _maxSupply, uint _totalVotesThreshold, uint _proposalThreshold, address _owner) ERC721(_name,  _symbol) {
